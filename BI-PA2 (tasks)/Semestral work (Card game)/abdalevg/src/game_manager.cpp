...
#include "person.h"
             ...
             GameManager::GameManager(){ 
                ...
                cout << "game manager cards size " << this->cards.size() << endl;
             ...
             bool GameManager::mainMenu( string option ){
                   ...
                   else if ( option == "3" ){ this->loadGame();    return false; }
        ...
        void GameManager::newGame(){
             ...
             console.outputConsole("two players?[Y/N]\n");

             string input = console.inputConsole();

             if( input == "Y" ){
                
                 console.outputConsole("input gamer1 name:\n");

                 Person person1( console.inputConsole() );

                 console.outputConsole("input gamer2 name:\n");

                 Person person2( console.inputConsole() );
 
                 //--------------------------------------------------

                 Game game( person1, person2, this->cards );              
                 ...
                 Game game( person1, gamerAI, this->cards );              
