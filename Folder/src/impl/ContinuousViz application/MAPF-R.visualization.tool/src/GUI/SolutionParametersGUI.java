...
/**
 * SolutionParametersGUI class controls window that displays data about solution:
 * solution name, number of agents, amount of vertices as well as density of graph, etc..
...
public class SolutionParametersGUI implements Initializable {
    ...
    private void setGraphParameters(String solutionName, Integer vertexAmount, Integer edgeAmount, Double graphDensity){
        ...
        graphParametersString += "agent amount: " + this.agentController.getAgentIDs().size() + "\n\n";
    ...
    private void setAgentParametersTree(){
        ...
        Set<Integer> agentIDs = this.agentController.getAgentIDs();
