...
/**
 * CollisionRiskData keeps data about rate of collision risk between two Agents during movement
 * @author Evgenii Abdalov
 */
public class CollisionRiskData {

    /**
     * TreeMap<Integer, TreeMap<Integer, Double>> collisionRiskDataMap, where key is the first Agent unique identifier,
     * and value is TreeMap<Integer, Double>, where key is the second Agent unique identifier and a value is Double
     * rate of collision risk between them
     */
    private TreeMap<Integer, TreeMap<Integer, Double>> collisionRiskDataMap;
