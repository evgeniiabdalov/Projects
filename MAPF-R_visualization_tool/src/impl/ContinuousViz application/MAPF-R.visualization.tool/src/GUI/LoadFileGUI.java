...
/**
 * LoadFileGUI class controls window that enables User to upload input files and create new solution
...
public class LoadFileGUI implements Initializable {
    ...
    /**
     * Calls MainGUI to upload new solution
     * @param solutionKey name of the solution that will be uploaded
     */
    ...
    /**
     * Opens Agent file dialogue window
     */
    @FXML
    ...
    /**
     * Opens Graph file dialogue window
     */
    @FXML
    ...
    /**
     * Opens Plan file dialogue window
     */
    @FXML
    ...
    /**
     * Check if files are not corupted and call MainGUI to upload new solution
     */
    @FXML
    ...
    /**
     * Opens Agent file dialogue window
     * @param mainGUI an instance of MainGUI with which communication is being handled
     */
